...
public final class ContentMainBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView datumListView;

  private ContentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView datumListView) {
    this.rootView = rootView;
    this.datumListView = datumListView;
  }
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.datum_list_view;
      RecyclerView datumListView = ViewBindings.findChildViewById(rootView, id);
      if (datumListView == null) {
        break missingId;
      }

      return new ContentMainBinding((ConstraintLayout) rootView, datumListView);
    }
